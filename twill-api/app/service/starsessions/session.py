...
from app.service.starsessions.exceptions import SessionNotLoaded


def default_session():
    return {
        # Save creation time so we can calculate age of the cookie
...
class Session:
    ...
    def get_age(self) -> int:
        """
        Get age of the session in seconds.
        """
        return self.data.get("_created_at") - datetime.utcnow().timestamp()
